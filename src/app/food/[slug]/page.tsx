...
export default function FoodPage({ params }: FoodPageProps) {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const fetchedFood = await getFood(slug);
            setFood(fetchedFood);
        }
        fetchData();
    }, [params]);
    ...
    if (!food) {
        return (
            <div className="bg-gray-950">
                <div className="border border-spacing-1 bg-slate-100 md:mx-20 md:mt-20 md:mb-10 mx-4 mb-4 p-8 rounded-2xl text-center mt-10 text-2xl md:text-6xl">
                    Loading...
                </div>
            </div>
        );
        ...
        <main className="bg-black">
            ...
            >
                ...
                <div className="flex items-center justify-center text-lg md:text-2xl">
                    <Link href={"/menu"}>
                        <h1 className="text-white">Our Food Menu</h1>
                    </Link>
